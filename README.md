...
Этот просмотрщик появился не как абстрактный pet‑project. Он создавался для мамы — врача, которой нужен был понятный рабочий инструмент: открыть папку с исследованием, быстро сравнить снимки, изменить яркость и контраст и скопировать данные пациента в отчёт.
